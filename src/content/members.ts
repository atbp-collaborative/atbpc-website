...
export const MEMBERS_DATA: Member[] = [
  {
    id: 'marchie-borja',
    name: 'Marchie Teodoro Borja',
    role: 'Principal Architect & Founder',
    license: 'RLA License No. 0054827',
    ...
    involvement: [
      {
        ...
        roleInProject: 'Lead Principal Architect',
        description: 'Envisioned the passive cooling strategies, concrete-wood aesthetic balance, and overall spatial zoning parameters.'
      },
      {
        projectId: 'retail---lifestyle-18',
        projectTitle: 'Retail & Lifestyle Project 1',
        roleInProject: 'Principal Concept Designer',
  ...
  },
  {
    ...
    license: 'Corporate Treasurer & Partner',
    ...
    involvement: [
      {
        projectId: 'multi-generational-8',
        projectTitle: 'Multi-Generational Project 1',
        roleInProject: 'Fiscal & Procurement Director',
  ...
  {
    id: 'nikka-oliveros',
    name: 'Nikka Jane Oliveros',
    role: 'Associate Architect',
    license: 'RLA License No. 0055109',
    ...
    involvement: [
      ...
      },
      {
        projectId: 'retail---lifestyle-18',
        projectTitle: 'Retail & Lifestyle Project 1',
        roleInProject: 'Project Architect',
        description: 'Created the detailed layout blueprints, plaster textures schedules, and structural hanger steel shop drawings.'
      },
      {
        projectId: 'workspaces-28',
        projectTitle: 'Workspaces Project 1',
        roleInProject: 'Associate BIM Modeler',
        description: 'Drafted complex building models and generated structural document checklists under strict quality parameters.'
      }
    ]
  },
  {
    ...
    involvement: [
      {
        projectId: 'multi-generational-8',
        projectTitle: 'Multi-Generational Project 1',
        roleInProject: 'Lead BIM Modeler',
  ...
  },
  {
    ...
    license: 'LID License No. 0008431',
    ...
    involvement: [
      {
        projectId: 'retail---lifestyle-18',
        projectTitle: 'Retail & Lifestyle Project 1',
        roleInProject: 'Lead Interior Designer',
  ...
  {
    id: 'christian-alipio',
    name: 'Christian Alipio',
    role: 'Construction Project Manager',
    license: 'RCE License No. 0098412',
    ...
    involvement: [
      {
        projectId: 'multi-generational-8',
        projectTitle: 'Multi-Generational Project 1',
        roleInProject: 'Construction Manager',
        description: 'Handled direct site administration, concrete pour quality inspections, and structural safety management.'
      },
      {
        projectId: 'food---beverage-24',
        projectTitle: 'Food & Beverage Project 1',
        roleInProject: 'Fabrication Supervisor',
        description: 'Managed the off-site fabrication of pre-cast lightweight components and safe delivery/rapid installation schedules.'
      }
    ]
  },
  {
    id: 'hannah-villanueva',
    name: 'Hannah Zarsaga Villanueva',
    role: 'Client Relations & Operations Manager',
    license: 'Operations & Administrative Lead',
    ...
    involvement: [
      {
        projectId: 'vacation-homes-12',
        projectTitle: 'Vacation Homes Project 1',
        roleInProject: 'Client Relations Manager',
        description: 'Managed client communication cadence, milestone sign-offs, and progress billing coordination.'
      },
      {
  ...
  {
    id: 'ernest-bambico',
    name: 'Ernest Bataller Bambico',
    role: 'Project Architect & Construction Detailer',
    license: 'RLA License No. 0061204',
    ...
    involvement: [
      {
        projectId: 'tiny-living-3',
        projectTitle: 'Tiny Living Project 1',
        roleInProject: 'Project Architect',
        description: 'Developed construction detail sets for compact spatial framing and resolved on-site buildability conflicts.'
      },
      {
        projectId: 'shared-places-32',
        projectTitle: 'Shared Places Project 1',
        roleInProject: 'Site Detailing Architect',
        description: 'Verified as-built conditions against design drawings and issued field revision notes during construction.'
      }
    ]
  },
  {
    id: 'john-dave-aquino',
    name: 'John Dave Lacaba Aquino',
    role: 'Design-Build Specialist',
    license: 'RLA License No. 0058873',
    ...
    involvement: [
      {
        projectId: 'vacation-homes-13',
        projectTitle: 'Vacation Homes Project 2',
        roleInProject: 'Design-Build Lead',
        description: 'Carried the design from schematic layout through shop drawings and on-site fabrication oversight.'
      },
      {
        projectId: 'sacred-structures-38',
        projectTitle: 'Sacred Structures Project 1',
        roleInProject: 'Fabrication Design Lead',
        description: 'Resolved joinery and structural detailing on-site to keep the original design intent through construction.'
      }
    ]
  },
  {
    id: 'rafael-bautista',
    name: 'Rafael Miguel Bautista',
    role: 'Site Engineer',
    license: 'RCE License No. 0102337',
    ...
    involvement: [
      ...
      {
        projectId: 'shared-spaces-40',
        projectTitle: 'Shared Spaces Project 1',
        roleInProject: 'Structural Site Lead',
        description: 'Coordinated crew scheduling and material testing to keep the build on program without cutting corners.'
      }
    ]
  },
  {
    id: 'patricia-yumang',
    name: 'Patricia Anne Yumang',
    role: 'Junior Architect',
    license: 'RLA License No. 0064910',
    ...
    involvement: [
      {
        projectId: 'tiny-living-4',
        projectTitle: 'Tiny Living Project 2',
        roleInProject: 'Junior Design Architect',
        description: 'Developed early schematic studies and material mood boards for client concept presentations.'
      },
      {
        projectId: 'shared-places-33',
        projectTitle: 'Shared Places Project 2',
        roleInProject: 'Design Support Architect',
        description: 'Assisted with layout iteration and produced presentation-ready renders for design review.'
      }
    ]
  },
  {
    id: 'andrea-fernandez',
    name: 'Andrea Nicole Fernandez',
    role: 'Design Director',
    license: 'RLA License No. 0067452',
  ...
  },
  {
    ...
    license: 'Certified Construction Supervisor',
    ...
    involvement: [
      {
        projectId: 'multi-generational-9',
        projectTitle: 'Multi-Generational Project 2',
        roleInProject: 'Construction Supervisor',
        description: 'Managed daily crew schedules, materials deliveries, and jobsite safety briefings.'
      },
      {
        projectId: 'vacation-homes-14',
        projectTitle: 'Vacation Homes Project 3',
        roleInProject: 'Site Supervisor',
        description: 'Coordinated labor allocation and sequencing to keep the build on schedule.'
      }
    ]
  },
  {
    id: 'kristelle-del-rosario',
    name: 'Kristelle Anne Del Rosario',
    role: 'Quantity Surveyor & Cost Estimator',
    license: 'Registered Quantity Surveyor',
    ...
    involvement: [
      {
        projectId: 'retail---lifestyle-19',
        projectTitle: 'Retail & Lifestyle Project 2',
        roleInProject: 'Cost Estimator',
        description: 'Prepared material take-offs and detailed cost estimates ahead of the construction budget approval.'
      },
      {
        projectId: 'workspaces-29',
        projectTitle: 'Workspaces Project 2',
        roleInProject: 'Quantity Surveyor',
        description: 'Tracked actual spend against budget throughout construction and flagged cost variances early.'
      }
    ]
  }
];
