      ...
      <div className="flex-1 flex flex-col md:flex-row gap-8 justify-center items-center min-h-0 my-auto py-1">
        ...
        <div className="w-full md:w-1/2 space-y-4">
          ...
          <div className="text-caption sm:text-body font-light leading-relaxed opacity-85 space-y-3">
            ...
            <p>We believe that true sustainability involves preserving cultural heritage and empowering local artisans. By integrating time-honored building techniques with contemporary standards, we create spaces that resonate with history while serving modern needs.</p>
          </div>
        </div>
      </div>
