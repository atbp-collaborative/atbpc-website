        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[2px] w-full max-w-7xl mx-auto items-stretch">
          {services.map((service) => {
            ...
            return (
              <div
                key={service.title}
                className={`flex flex-col border transition-all duration-500 rounded-none overflow-hidden ${isDarkMode
              ...
              >
                ...
                <div className="p-3 sm:p-4 flex flex-col flex-grow space-y-1.5">
                  <h3 className={`font-sans text-caption sm:text-body font-bold tracking-tight capitalize ${isDarkMode ? 'text-white' : 'text-slate-950'
                    }`}>
                    {service.title}
                  </h3>
