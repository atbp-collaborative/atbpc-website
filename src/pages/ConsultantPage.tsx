...
export const ConsultantPage: React.FC<ConsultantPageProps> = ({ isDarkMode }) => {
      ...
      <AnimatePresence mode="wait">
        {!isSubmitted ? (
                ...
                <div className="space-y-0.5">
                  ...
                  <div className={`h-[72px] p-2 border rounded-xl flex flex-col justify-center ${inputBorderClass}`}>
                    <textarea
                      ...
                      onChange={handleInputChange}
                      placeholder="PRC / PTR License Verification (Link to License)"
                      className="w-full h-full bg-transparent text-[10px] leading-tight outline-none resize-none placeholder-inherit"
                    />
                  </div>
                </div>
          ...
          >
            ...
            <h2 className="text-h2 font-bold tracking-tight">Consultant Registration Submitted</h2>
            <p className="text-caption opacity-80 leading-relaxed">
              Thank you for applying as a partner consultant with ATBP Collaborative. Our engineering and design leadership will review your credentials and contact you directly.
            </p>
            <button
              onClick={resetForm}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              <div className="flex items-center space-x-2 text-space-sparkle">
                <Shield size={20} />
                <h3 className="text-h3 font-bold">General Conditions for Consultant Partnership</h3>
              </div>
