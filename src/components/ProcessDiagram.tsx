...
export const ProcessDiagram = () => {
  ...
  const getNodeClassName = (isSelected: boolean, isNext: boolean, isFlattened: boolean, isDarkMode: boolean) => {
    const base = `group relative flex flex-col items-center justify-center text-center p-1 cursor-pointer transition-all duration-300 shadow-md w-12 sm:w-16 md:w-20 lg:w-24 ${
      isFlattened
    ...
    if (isSelected) {
      return `${base} ${isDarkMode ? 'bg-white text-vintage-charcoal ring-2 sm:ring-4 ring-white/30 font-bold border-white' : 'bg-vintage-charcoal text-white ring-2 sm:ring-4 ring-vintage-charcoal/30 font-bold border-vintage-charcoal'}`;
    }
    
    if (isNext) {
      return `${base} ${isDarkMode ? 'bg-white text-vintage-charcoal ring-2 sm:ring-4 ring-white/30 animate-pulse border-white/40 shadow-lg font-bold' : 'bg-white text-vintage-charcoal ring-2 sm:ring-4 ring-vintage-charcoal/20 animate-pulse border-vintage-charcoal/40 shadow-lg font-bold'}`;
    }
    
    return `${base} ${isDarkMode ? 'bg-white/90 text-vintage-charcoal hover:bg-white hover:ring-2 hover:ring-white/40 border-white/20' : 'bg-white text-vintage-charcoal border border-slate-200 hover:border-vintage-charcoal hover:shadow-lg'}`;
  };
