...
export const Step2Services: React.FC<Props> = ({ formData, updateField, isDarkMode }) => {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-8">
        <h2 className="font-sans text-h2 font-bold text-space-sparkle mb-2">Step 2. Project Typology & Services</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <h3 className="font-sans text-h3 font-bold mb-4">2a. Project Typology & Services</h3>
        ...
        <div>
          <h3 className="font-sans text-h3 font-bold mb-4">2b. Services & Scope</h3>
          <div className="space-y-4">
            <SelectField
              name="services"
              label="Services"
