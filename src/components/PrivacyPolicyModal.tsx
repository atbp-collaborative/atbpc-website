...
import { X, ShieldCheck, Lock, FileText, UserCheck, Scale, Globe } from 'lucide-react';
          ...
          >
            ...
            <div className={`flex items-center justify-between px-6 py-5 border-b sticky top-0 z-20 backdrop-blur-md ${
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-h3 font-sans font-bold tracking-tight">Privacy Policy</h2>
                  <p className="text-mini opacity-60 font-sans uppercase tracking-wider">
                    ATBP Collaborative • Design-Build Practice
                  </p>
                </div>
              </div>
